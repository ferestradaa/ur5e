...
class FrankaRmpFlowExample():
    ...
    def load_example_assets(self):
        ...
        stage_path = '/World'
        robot_prim_path = "/World/robot/test1_clean"
        path_to_robot_usd = "/home/aist/Desktop/FES/scenario1/RmpFlow_Example_python/ur5e_world3.usd"
        ...
        self._target = VisualCylinder("/World/target/target",scale=[0.04, 0.04, 0.06],color=np.array([0.1,0.0,0.0]))
